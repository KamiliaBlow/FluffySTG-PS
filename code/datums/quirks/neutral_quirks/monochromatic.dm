/datum/quirk/monochromatic
	name = "Монохромазия"
	desc = "Вы страдаете полной цветовой слепотой и воспринимаете практически весь мир в черно-белых тонах."
	icon = FA_ICON_ADJUST
	value = 0
	medical_record_text = "Пациент страдает практически полной цветовой слепотой."
...
/datum/quirk/monochromatic/post_add()
	if(is_detective_job(quirk_holder.mind.assigned_role))
		to_chat(quirk_holder, span_bolddanger("Ммм. На этой станции никогда ничего не бывает ясно. Все такое... в оттенках серого..."))
