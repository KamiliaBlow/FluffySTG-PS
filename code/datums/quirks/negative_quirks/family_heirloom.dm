...
/datum/quirk/item_quirk/family_heirloom/post_add()
	...
	if(!family_heirloom)
		to_chat(quirk_holder, span_boldnotice("Волна экзистенциального страха охватывает вас, когда вы понимаете, что ваша драгоценная семейная реликвия пропала. Возможно, боги проявят милосердие к вашей проклятой душе?"))
		return
