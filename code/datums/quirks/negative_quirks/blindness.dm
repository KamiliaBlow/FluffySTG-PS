/datum/quirk/item_quirk/blindness
	...
	icon = FA_ICON_BLIND
	value = -16
	gain_text = span_danger("Вы ничего не видите.")
	lose_text = span_notice("Вы чудесным образом восстанавливаете зрение.")
	medical_record_text = "Пациент страдает постоянной слепотой."
	hardcore_value = 15
