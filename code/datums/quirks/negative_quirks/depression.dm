/datum/quirk/depression
	...
	icon = FA_ICON_FROWN
	value = -3
	gain_text = span_danger("Вы начинаете чувствовать себя депрессивно.")
	lose_text = span_notice("Вы больше не чувствуете себя депрессивно.") //if only it were that easy!
	medical_record_text = "У пациента наблюдается легкое расстройство настроения, вызывающее острые эпизоды депрессии."
