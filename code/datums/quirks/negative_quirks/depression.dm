/datum/quirk/depression
	name = "Депрессия"
	desc = "Иногда просто ненавидишь жизнь."
	icon = FA_ICON_FROWN
	value = -3
	gain_text = span_danger("Вы начинаете чувствовать себя подавленно.")
	lose_text = span_notice("Вы больше не чувствуете подавленно.") //if only it were that easy!
