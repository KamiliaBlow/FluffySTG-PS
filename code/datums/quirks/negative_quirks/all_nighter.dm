...
/datum/quirk/all_nighter
	...
	gain_text = span_danger("Вы чувствуете себя измученно.")
	lose_text = span_notice("Вы чувствуете что хорошо отдохнули.")
	medical_record_text = "Пациент, по-видимому, страдает от недосыпания."
	hardcore_value = 2
