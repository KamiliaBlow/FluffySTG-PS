/datum/quirk/tin_man
	name = "Tin Man"
	desc = "Упс! Полное протезирование! В результате какого-то действительно жестокого космического наказания большинство ваших внутренних органов были заменены дешевыми протезами."
	icon = FA_ICON_USER_GEAR
	value = -6
	medical_record_text = "При физическом осмотре у пациента было обнаружено множество недорогих протезов внутренних органов. \
...
/datum/quirk/tin_man/post_add()
	to_chat(quirk_holder, span_bolddanger("Большинство ваших внутренних органов были заменены дешевыми протезами. Они хрупкие и легко разваливаются под давлением. \
	Кроме того, любой ЭМИ разряд приведет к их полной остановке."))
