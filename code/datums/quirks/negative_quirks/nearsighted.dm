/datum/quirk/item_quirk/nearsighted
	name = "Nearsighted"
	desc = "У вас близорукость и вы ничего не видите без очков, но появляетесь с парой очков."
	icon = FA_ICON_GLASSES
	value = -4
	gain_text = span_danger("Вещи, которые находятся далеко от вас, начинают казаться размытыми.")
	lose_text = span_notice("Вы снова начинаете нормально видеть удаленные предметы.")
	medical_record_text = "Пациенту требуются очки по рецепту для коррекции близорукости."
	hardcore_value = 5
