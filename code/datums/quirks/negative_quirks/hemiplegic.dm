/datum/quirk/hemiplegic
	name = "Гемиплегия"
	desc = "Половина вашего тела не работает. Ничто не исправит это."
	icon = FA_ICON_CIRCLE_HALF_STROKE
	value = -10 // slightly more bearable than paraplegic but not by much
	gain_text = null // Handled by trauma.
	lose_text = null
	medical_record_text = "Пациент имеет неизлечимое нарушение двигательной функции половины тела."
	hardcore_value = 10
	mail_goodies = list(
...
/datum/quirk/hemiplegic/add(client/client_source)
	...
	medical_record_text = "Пациент имеет неизлечимое нарушение двигательной функции в [side_choice::paralysis_type] половине тела."
