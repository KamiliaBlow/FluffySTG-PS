/datum/language/common
	name = "Sol Common"
	desc = "И когда связь была установлена, адмирал помахал рукой в сторону экрана и сказал, \"Mi parolas la lingvon de la Homines!\" - Я говорю на языке человечества. Упрощенная смесь эсперанто и современной латыни, единственный признанный официальный язык Sol Federation. Этот своеобразный искусственный язык стал популярным в первые дни существования SolFed, но вскоре был почти полностью вытеснен другими популярными языками - он получил широкое распространение благодаря жестким политическим маневрам с помощью корпоративных бюрократов и других нежелательных элементов. В настоящее время это почти универсальный язык, который должен знать каждый разумный человек, планирующий отправиться в космос."
	sentence_chance = 0
